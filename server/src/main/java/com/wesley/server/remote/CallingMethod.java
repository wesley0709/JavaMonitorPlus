package com.wesley.server.remote;

import com.wesley.server.core.entity.JstackEntity;
import com.wesley.server.remote.util.HttpUtil;
import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.wesley.server.core.entity.JinfoEntity;
...
public class CallingMethod {
    ...
    public static JSONObject getSystemInfo(String address) throws IOException {
        String url = address + "/systemInfo";
        String body = connectHost(url);
